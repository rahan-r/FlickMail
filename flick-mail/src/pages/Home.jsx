    ...
    <div className="flex flex-col min-h-screen ">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link className="flex items-center justify-center" href="#">
          ...
          <span className="font-semibold"><img src="https://i.postimg.cc/FK3VVvGr/logo.png" alt="" style={{height: '95px' }} /></span>
        </Link>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <span className="bg-gradient-to-r from-[#E65100] to-[#E65100] bg-clip-text text-transparent">
                ...
                <p className="mx-auto max-w-[700px] text-gray-900 md:text-[20px] dark:text-gray-400">
                  Protect your inbox. Use disposable email service for quick, secure, and spam-free communication.
                </p>
              </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3 lg:gap-12">
              <Card className='border-2 border-[#FF6F00]'>
                <CardHeader>
                  ...
                  <CardDescription>Get a temporary email address in seconds. No registration required.</CardDescription>
                </CardHeader>
              </Card>
              <Card className='border-2 border-[#FF6F00]'>
                <CardHeader>
                  ...
                  <CardDescription>Keep your real email private. Perfect for sign-ups and trials.</CardDescription>
                </CardHeader>
              </Card>
              <Card className='border-2 border-[#FF6F00]'>
                <CardHeader>
                  ...
                  <CardDescription>Simple interface to view and manage your temporary emails.</CardDescription>
                </CardHeader>
              </Card>
            </div>
          </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 Temp Mail. All rights reserved.</p>
