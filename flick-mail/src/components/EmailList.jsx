...
import { StarIcon, ArchiveBoxIcon, TrashIcon, InboxIcon } from '@heroicons/react/24/outline';
...
export default function EmailList({ emails = [], onSelectEmail }) {
    ...
    return (
        <div className="h-full overflow-auto">
            ...
            <p className="text-zinc-400 p-2 text-sm mb-4">Received emails will appear here</p>
            <hr />
